 ...
 */
function createBaseOptions(options: ServiceLoggerOptions): LoggerOptions {
  const {
    serviceName,
 ...
 * ```
 */
export function createLogger(options: ServiceLoggerOptions): Logger {
 ...
 */
export function requestLoggingHook(logger: Logger) {
...
export function responseLoggingHook() {
  return async function onResponse(request: any, reply: any) {
